  ...
  const handleInputChange=(property:string, value: string)=>{
    ...
    return (
        <section className="flex flex-col border-t border-primary-grey-100 bg-primary-black text-primary-grey-300 min-2-[227px] sticky right-0 h-full max-sm:hidden select-none">
            ...
            <Color inputRef={colorInputRef} attribute={elementAttributes.fill} attributeType="fill" placeholder="color" handleInputChange={handleInputChange}/>
            <Color inputRef={strokeInputRef} attribute={elementAttributes.stroke} attributeType="stroke" placeholder="color" handleInputChange={handleInputChange}/>
            <Export />
        </section>
    );
};
